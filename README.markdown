...
A Python script to download videos, audio, and playlists using `yt-dlp`. Supports single or multiple URLs, playlist downloads, and cross-platform compatibility (Linux/Windows).
